    ...
    <div name ='Home' className='w-full h-screen banner'>
        ...
        <div className='max-w-[1000px] mx-auto h-full px-8 flex flex-col justify-center'>
            ...
            <p className='py-4 max-w-[700px]'>
                A scientific software developer is a person who develops science based software for research used by scientific organisation,institution or individual use. In addition of mastering  React Js, C++ and Python, I am 
                focus on building software infrastracture for Physics studies at the moment.     
            </p>
            <div>
