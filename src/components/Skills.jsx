    ...
    <div name= 'skills' className='w-full h-screen skill text-gray-800'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full -h-full'>
        <div>
          ...
          <p className='py-4'> your design portfolio should should shoucase your best work. Include and interactive prototype. A website in motion not just static images</p>
        </div>
